...
Usage
-----
    python migrate_artifacts.py                        # dry run  (prints what would happen)
    python migrate_artifacts.py --execute              # actually renames directories
    python migrate_artifacts.py --root /path/to/arts   # custom artifacts root
"""
