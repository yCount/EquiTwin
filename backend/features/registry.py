...
# Columns that appear in base_cols for context / filtering but must NOT become
# model features because they are absent from the real-time inference buffer.
# 'quality'  – AQ sensor string tag  (e.g. "EXCELLENT")
# 'version'  – firmware version string (e.g. "v0.8.5-EU-RELEASE")
...
ENERGY = FeatureSpec(
    ...
    lag_cols=[
        ...
        "a_voltage","b_voltage","c_voltage",
        "num_targets","temp",
        # Numeric weather lags (weather_condition is categorical; kept in base_cols only)
